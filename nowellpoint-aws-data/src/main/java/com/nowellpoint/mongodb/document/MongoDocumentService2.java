...
public class MongoDocumentService2 extends AbstractCacheService {
	
	protected static final ObjectMapper objectMapper = new ObjectMapper();
	
	private static final Logger LOGGER = Logger.getLogger(MongoDocumentService2.class);
	...
	public <T> FindIterable<T> query(Class<T> documentClass, Bson query) {
	...
	public <T> T find(Class<T> documentClass, ObjectId id) {	
