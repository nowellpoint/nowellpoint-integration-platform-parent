...
//	static String render(Request request, Map<String,Object> model, String templateName) {	
...
//    }
//	
//	static AccountProfile getAccount(Request request) {
//		return request.attribute("account");
//	}
//	
//	static Locale getDefaultLocale(AccountProfile accountProfile) {
//		Locale locale = null;
...
//			}
//		} else {
//			locale = getConfiguration().getLocale();
//		}
//		return locale;
//	}
//	
...
//	
//	public Controller(Class<?> controllerClass, Configuration configuration) {		
