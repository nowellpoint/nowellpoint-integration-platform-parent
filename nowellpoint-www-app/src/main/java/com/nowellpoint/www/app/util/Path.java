...
public class Path {
	...
	public static class Route {
		...
		public static final String APPLICATION_CREATE = String.format(APPLICATION_CONTEXT, "applications/create");
		public static final String APPLICATION_UPDATE = String.format(APPLICATION_CONTEXT, "applications/:id/update");
		...
		public static final String APPLICATION_ENVIRONMENT_REMOVE = String.format(APPLICATION_CONTEXT, "applications/:id/environments/:key/remove");
		...
		public static final String APPLICATION_SERVICE_ADD = String.format(APPLICATION_CONTEXT, "applications/:id/services/add");
		public static final String APPLICATION_SERVICE_UPDATE = String.format(APPLICATION_CONTEXT, "applications/:id/services/:key/update");
		...
		public static final String CONNECTORS_SALESFORCE_UPDATE = String.format(APPLICATION_CONTEXT, "connectors/salesforce/:id/update");
		...
		public static final String CONNECTORS_SALESFORCE_ENVIRONMENT_REMOVE = String.format(APPLICATION_CONTEXT, "connectors/salesforce/:id/environments/:key/remove");
		...
		public static final String CONNECTORS_SALESFORCE_SERVICE_ADD = String.format(APPLICATION_CONTEXT, "connectors/salesforce/:id/services/add");
		public static final String CONNECTORS_SALESFORCE_SERVICE_UPDATE = String.format(APPLICATION_CONTEXT, "connectors/salesforce/:id/services/:key/update");
