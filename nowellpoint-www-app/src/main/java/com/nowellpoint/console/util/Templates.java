...
public class Templates {
	...
	public static final String EVENT_LISTENER_SETUP = String.format(APPLICATION_CONTEXT, "organization-event-listener-setup.ftl");
	...
	public static final String ORGANIZATION_EVENT_LISTENERS_OVERVIEW = String.format(APPLICATION_CONTEXT, "organization-event-listeners-overview.ftl");
