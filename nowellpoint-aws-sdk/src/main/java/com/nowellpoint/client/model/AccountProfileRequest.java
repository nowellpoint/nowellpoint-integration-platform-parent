...
public class AccountProfileRequest extends AbstractResource {
	...
	public AccountProfileRequest(String id) {
		this();
		this.setId(id);
	}
	...
	public AccountProfileRequest withId(String id) {
		setId(id);
		return this;
	}
	
	public AccountProfileRequest withLastName(String lastName) {
		setLastName(lastName);
		return this;
	}
	
	public AccountProfileRequest withFirstName(String firstName) {
		setFirstName(firstName);
		return this;
	}
	
	public AccountProfileRequest withCompany(String company) {
		setCompany(company);
		return this;
	}
	
	public AccountProfileRequest withDivision(String division) {
		setDivision(division);
		return this;
	}
	
	public AccountProfileRequest withDepartment(String department) {
		setDepartment(department);
		return this;
	}
	
	public AccountProfileRequest withTitle(String title) {
		setTitle(title);
		return this;
	}
	
	public AccountProfileRequest withEmail(String email) {
		setEmail(email);
		return this;
	}
	
	public AccountProfileRequest withPhone(String phone) {
		setPhone(phone);
		return this;
	}
	...
	public AccountProfileRequest withMobilePhone(String mobilePhone) {
		setMobilePhone(mobilePhone);
		return this;
	}
	
	public AccountProfileRequest withLanguageSidKey(String languageSidKey) {
		setLanguageSidKey(languageSidKey);
		return this;
	}
	
	public AccountProfileRequest withLocaleSidKey(String localeSidKey) {
		setLocaleSidKey(localeSidKey);
		return this;
	}
	
	public AccountProfileRequest withTimeZoneSidKey(String timeZoneSidKey) {
		setTimeZoneSidKey(timeZoneSidKey);
		return this;
	}

	public AccountProfileRequest withEnableSalesforceLogin(Boolean enableSalesforceLogin) {
